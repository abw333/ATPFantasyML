...
class Set(unittest.TestCase):
  ...
  def test_init_args(self):
    zet = tennis.Set([tennis.Game(1, 2)], 3, 4)
  ...
  def test_init_kwargs(self):
    zet = tennis.Set(tiebreak_points=1, tiebreak_games=2, games=[tennis.Game(3, 4)])
  ...
  def test_winner(self):
    self.assertIsNone(tennis.Set(games=[tennis.Game(4, 0)] * 2 + [tennis.Tiebreak(0, 0, 2)], tiebreak_games=1, tiebreak_points=2).winner())

    self.assertTrue(tennis.Set(games=[tennis.Tiebreak(2, 0, 0)], tiebreak_games=0, tiebreak_points=0).winner())

    self.assertFalse(tennis.Set(games=[tennis.Game(4, 0)] * 4 + [tennis.Tiebreak(0, 4, 4)], tiebreak_games=2, tiebreak_points=4).winner())
  ...
  def test_point(self):
    ...
    zet = tennis.Set([tennis.Game(4, 0)] * 3 + [tennis.Game(3, 0)], 2, 3)
    self.assertIsNone(zet.point(False))
    self.assertEqual(zet, tennis.Set([tennis.Game(4, 0)] * 4 + [tennis.Tiebreak(0, 0, 3)], 2 ,3))
    self.assertIsNone(zet.point(True))
    self.assertEqual(zet, tennis.Set([tennis.Game(4, 0)] * 4 + [tennis.Tiebreak(1, 0, 3)], 2, 3))
    self.assertIsNone(zet.point(True))
    self.assertEqual(zet, tennis.Set([tennis.Game(4, 0)] * 4 + [tennis.Tiebreak(2, 0, 3)], 2, 3))
    self.assertTrue(zet.point(True))
    self.assertEqual(zet, tennis.Set([tennis.Game(4, 0)] * 4 + [tennis.Tiebreak(3, 0, 3)], 2, 3))

    zet = tennis.Set([tennis.Game(4, 0), tennis.Game(3, 0)], 1, 2)
    self.assertIsNone(zet.point(False))
    self.assertEqual(zet, tennis.Set([tennis.Game(4, 0)] * 2 + [tennis.Tiebreak(0, 0, 2)], 1, 2))
    self.assertIsNone(zet.point(False))
    self.assertEqual(zet, tennis.Set([tennis.Game(4, 0)] * 2 + [tennis.Tiebreak(0, 1, 2)], 1, 2))
    self.assertFalse(zet.point(False))
    self.assertEqual(zet, tennis.Set([tennis.Game(4, 0)] * 2 + [tennis.Tiebreak(0, 2, 2)], 1, 2))
